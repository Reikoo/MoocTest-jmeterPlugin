...
public class JMeterMenuBar extends JMenuBar implements LocaleChangeListener {
    ...
    //modify by grj
    private void makeMoocTestMenu(){
    	/**does not consider about zone and language
    	moocTestJMenu = new JMenu("MoocTest"); 
    	
    	loginMenuItem = new JMenuItem("1. Login");
    	loginMenuItem.setEnabled(true);
    	
    	downloadMenuItem = new JMenuItem("2. Download");
    	downloadMenuItem.setEnabled(true);
    	
    	runMenuItem = new JMenuItem("3. Run");
    	runMenuItem.setEnabled(true);
    	
    	submitMenuItem = new JMenuItem("4. Submit");
    	...
    	*/
    	//consider about zone and language
    	moocTestJMenu = makeMenuRes("mooctest",'M');
    	
    	loginMenuItem = makeMenuItemRes("mooctest_login", ActionNames.MOOCTEST_LOGIN);
    	loginMenuItem.setEnabled(true);
    	...
    	submitMenuItem = makeMenuItemRes("mooctest_submit", ActionNames.MOOCTEST_SUBMIT);
    	submitMenuItem.setEnabled(true);
